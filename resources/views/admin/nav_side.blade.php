...
<head>
  ...
  <title>Repid Rescue Admin</title>
  <!-- plugins:css -->
  <link rel="stylesheet" href="admin/vendors/feather/feather.css">
  <link rel="stylesheet" href="admin/vendors/ti-icons/admin/css/themify-icons.css">
  <link rel="stylesheet" href="admin/vendors/admin/css/vendor.bundle.base.css">
  <!-- endinject -->
...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('add-ambulance')}}">
              <span class="menu-title">Add Ambulance</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('add-ambulance')}}">
              ...
              <span class="menu-title">All Ambulance</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('all-driver')}}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/documentation/documentation.html" class="btn btn-primery">
  ...
  <!-- plugins:js -->
  <script src="admin/vendors/admin/js/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <script src="admin/vendors/chart.admin/js/Chart.min.js"></script>
